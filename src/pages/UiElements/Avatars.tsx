...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | Admin SMS- React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for Admin SMS- React.js Tailwind CSS Admin Dashboard Template"
      />
